...
Αναφορά στον πλήρη κώδικα: \hyperlink{GitHub}{https://github.com/IBilba/stock-price-linear-regression} % chktex 19
...
Λάβετε δωρεάν API key από: \url{https://www.alphavantage.co/support/\#api-key} % chktex 19
